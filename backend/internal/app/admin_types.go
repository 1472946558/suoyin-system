...
const (
	...
	AdminPagePaymentConfig AdminPageID = "payment-config"
	AdminPagePaymentRecord AdminPageID = "payment-records"
...
type AdminPaymentConfig struct {
	...
	Cash struct {
		...
		ShiftReconciliationRequired bool `json:"shiftReconciliationRequired"`
	} `json:"cash"`
	BankTransfer struct {
		Enabled       bool   `json:"enabled"`
	...
	Reconciliation struct {
		...
		AbnormalNotify   string `json:"abnormalNotify"`
	} `json:"reconciliation"`
}
...
type AdminPrintTemplate struct {
	Receipt struct {
		...
		ShowPaymentMethod   bool     `json:"showPaymentMethod"`
...
type AdminBootstrap struct {
	...
	PaymentConfig  AdminPaymentConfig      `json:"paymentConfig"`
	PrintTemplate  AdminPrintTemplate      `json:"printTemplate"`
	PaymentRecords []AdminPaymentRecord    `json:"paymentRecords"`
